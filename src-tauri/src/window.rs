...
#[tauri::command]
pub fn set_content_protected(app: tauri::AppHandle, protected: bool) -> Result<(), String> {
    if let Some(window) = app.get_webview_window("main") {
        let _ = window.set_content_protected(protected);
    }
    if let Some(dashboard) = app.get_webview_window("dashboard") {
        let _ = dashboard.set_content_protected(protected);
    }
    Ok(())
}

#[tauri::command]
pub fn get_content_protected(_app: tauri::AppHandle) -> Result<bool, String> {
    Ok(true)
}
