...
export interface ResponseTriggerOption {
  id: string;
  name: string;
  description: string;
}

export const RESPONSE_TRIGGERS: ResponseTriggerOption[] = [
  {
    id: "auto_question",
    name: "On Question (Recommended)",
    description: "Automatically responds when someone asks a question in the meeting",
  },
  {
    id: "auto_all",
    name: "After Every Pause",
    description: "Automatically responds after every detected speech segment",
  },
  {
    id: "manual_suggest",
    name: "Manual (Suggest Only)",
    description: "Listens silently until you click Suggest or press Ctrl/Cmd + Enter",
  },
];

export const DEFAULT_RESPONSE_TRIGGER = "auto_question";
